...
현재 개발 버전은 **1.0.10 (versionCode 11)**이며, 배포별 변경사항은 [RELEASE_NOTES.md](RELEASE_NOTES.md)에 기록합니다. 별도 요청이 없으면 모든 신규 배포에서 `versionName`과 `versionCode`를 함께 올립니다.
